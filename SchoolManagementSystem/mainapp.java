            ...
            switch(userOption){
                ...
                case 2:{
                    ...
                    for(Teacher j:teacherList){
                        if(j.getName().equals(userOptionName)){
                            System.out.println("\n"+j.getName()+" has a salary of $"+j.getSalary()+" and he earned $"+j.getSalaryEarned()+"\n");
                        }
                    }
                    break;
                }
                ...
                case 4:{
                    ...
                    for(Student j:studentList){
                        if(j.getName().equals(userOptionName)){
                            System.out.println("\n"+j.getName()+" has paid $"+j.getFeesPaid()+" out of a total $"+j.getFeesTotal()+"\n");
                        }
                    }
                    break;
                }
                    ...
                    if(userOptionMoney>=0){
                        for(Student j:studentList){
                            if(j.getName().equals(userOptionName)){
                                ...
                                System.out.println("\n"+j.getName()+" payed $"+j.getFeesPaid()+" and has $"+j.getRemainingFees()+" fees remaining\n");
                            }
                            else{
